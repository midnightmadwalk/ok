...
window.addEventListener('wheel', (event) => {
    ...
    if (characterControls) {
        ...
        const cameraOffset = new THREE.Vector3(0, 7, -5); // Adjust Y for height, Z for distance behind
        ...
        characterControls.updateCameraTarget = function() {
            ...
            const behindPosition = new THREE.Vector3(0, 1, 1); // Point behind
            ...
            camera.position.lerp(behindPosition, 0.5); // Smoothly follow with linear interpolation
